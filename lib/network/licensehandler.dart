...
Future<List<License>> getPilotLicense(String id) async {
  String request = 'http://' + ipAddr + ':81/pilot/license/' + id + '/all';
  print(request);
  ...
  if (response.statusCode != 404) {
    ...
    return parsed.map<License>((json) => License.fromJson(json)).toList();
...
Future<Map> addLicenseHandler(String req_body, String id) async {
  String request = 'http://' + ipAddr + ':81/pilot/license/' + id + '/create';
  print(request);
...
void sendImage(String license, String oid, File img) async {
  String uri = 'http://' +
      ipAddr +
      ':81/pilot/license/' +
      license +
...
Future<Uint8List> receiveImage(String license, String oid) async {
  String uri =
